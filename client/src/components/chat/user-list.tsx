    ...
    <div className="h-full w-full bg-[#1e1e1e] dark:bg-[#1e1e1e] border-r border-zinc-800 flex flex-col theme-transition messenger-sidebar">
      ...
      <div className="p-4 border-b border-zinc-800 flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <button className="w-9 h-9 rounded-full bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center text-zinc-400 transition-colors">
      ...
      <div className="flex border-b border-zinc-800">
        <button className="flex-1 py-3 text-sm font-medium text-white messenger-active-tab">
          Inbox
        </button>
        <button className="flex-1 py-3 text-sm font-medium text-zinc-400">
          Communities
        </button>
        <button className="flex-1 py-3 text-sm font-medium text-zinc-400">
          Archive
      ...
      <div className="p-3">
        <div className="relative">
          <Input
            ...
            className="pl-10 py-2 h-10 bg-zinc-800 border-0 text-zinc-200 rounded-full focus-visible:ring-1 focus-visible:ring-messenger-yellow"
            value={searchQuery}
        ...
        <div className="p-2 space-y-1">
          {isLoading ? (
            ...
            <div className="p-8 text-center">
              <div className="w-16 h-16 bg-zinc-800 rounded-full mx-auto flex items-center justify-center mb-3">
              ...
              <p className="text-white text-sm font-medium">No results found</p>
